...
public class Parser {
    ...
    public static void parse(File file, AddService serv) throws FileNotFoundException {
    ...
    public static void parseAbilities(File file, AddService addServ) throws FileNotFoundException {
    ...
    public static void parseBattles(File file, AddService addServ) throws FileNotFoundException {
    ...
    public static void parseCharacters(File file, AddService addServ) throws FileNotFoundException {
    ...
    public static void parseTeams(File file, AddService addServ) throws FileNotFoundException {
        addServ.clear("Teams");
        // skip first two lines
        Scanner fileScan = new Scanner(file);
        fileScan.nextLine();
